...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/ulmentflam/Proxmox/experimental/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
